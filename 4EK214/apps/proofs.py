...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""[^1]: [Hansen (2022)](https://www.econometricsociety.org/publications/econometrica/2022/05/01/modern-gauss%E2%80%93markov-theorem) showed, that if OLS is BLUE, then it may automatically be BUE.""")
    return
